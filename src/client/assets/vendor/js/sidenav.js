        ...
        l = (function () {
          function e(n) {
            ...
            if (
              (i(this, e),
              (this._el = n),
              (this._horizontal = "horizontal" === t.orientation),
              (this._animate =
                !1 !== t.animate && this._supportsTransitionEnd()),
              (this._accordion = !1 !== t.accordion),
              (this._closeChildren = Boolean(t.closeChildren)),
              (this._showDropdownOnHover = Boolean(t.showDropdownOnHover)),
              (this._rtl =
              ...
              n.classList.add("sidenav-horizontal"),
                n.classList.remove("sidenav-vertical"),
                (this._inner = n.querySelector(".sidenav-inner"));
              var o = this._inner.parentNode;
              (this._prevBtn = n.querySelector(".sidenav-horizontal-prev")),
                this._prevBtn ||
                  ((this._prevBtn = document.createElement("a")),
                  (this._prevBtn.href = "#"),
                  (this._prevBtn.className = "sidenav-horizontal-prev"),
                  o.appendChild(this._prevBtn)),
                (this._wrapper = n.querySelector(
                ...
                (this._nextBtn = n.querySelector(".sidenav-horizontal-next")),
                this._nextBtn ||
              ...
              n.classList.add("sidenav-vertical"),
                n.classList.remove("sidenav-horizontal");
              var r = s || window.PerfectScrollbar;
              r &&
                (this._scrollbar = new r(n.querySelector(".sidenav-inner"), {
                  suppressScrollX: !0,
                  wheelPropagation: !0,
                }));
            }
            ...
            (t = [
              {
                ...
                value: function (e) {
                  ...
                  if (i) {
                    ...
                    this._promisify(this._onOpen, this, i, s, this._findMenu(i))
                      .then(function () {
                        n._horizontal && n._isRoot(i)
                          ? (n._toggleDropdown(!0, i, t),
                            n._onOpened && n._onOpened(n, i, s, n._findMenu(i)))
                          : n._animate
                          ? (window.requestAnimationFrame(function () {
                              return n._toggleAnimation(!0, i, !1);
                            }),
                            n._accordion && n._closeOther(i, t))
                ...
                value: function (e) {
                  ...
                  s.classList.contains("open") &&
                    ...
                    this._promisify(
                      ...
                      .then(function () {
                        if (n._horizontal && n._isRoot(s))
                          n._toggleDropdown(!1, s, t),
                          ...
                          if ((s.classList.remove("open"), t))
                            for (
                              var e = s.querySelectorAll(".sidenav-item.open"),
                                i = 0,
                                r = e.length;
                              i < r;
                              i++
                            )
                              e[i].classList.remove("open");
                          n._onClosed && n._onClosed(n, s, o, n._findMenu(s));
                        }
                      })
                      .catch(function () {});
              ...
              },
              {
                ...
                value: function (e, n) {
                  ...
                  if (n && i)
                    for (
                      var o = this._el.querySelectorAll(
                  ...
                  for (; s; )
                    s.classList[n ? "add" : "remove"]("active"),
                      (s = this._findParent(s, "sidenav-item", !1));
                },
              },
              {
                key: "setDisabled",
                value: function (e, n) {
                  this._getItem(e, !1).classList[n ? "add" : "remove"](
                    "disabled"
                  );
                },
              },
              ...
              },
              {
                ...
                value: function () {
                  if (this._horizontal) {
                    ...
                    e - t > n &&
                      ((t = e - n) > 0 && (t = 0), (this._innerPosition = t)),
                      this._updateSlider(e, n, t);
              ...
              },
              {
                ...
                value: function () {
                  if (this._el) {
                    this._unbindEvents();
                    for (
                      var e = this._el.querySelectorAll(".sidenav-item"),
                        n = 0,
                        t = e.length;
                      n < t;
                      n++
                    )
                      this._unbindAnimationEndEvent(e[n]),
                        e[n].classList.remove("sidenav-item-animating"),
                        e[n].classList.remove("open"),
                        (e[n].style.overflow = null),
                        (e[n].style.height = null);
                    for (
                      var i = this._el.querySelectorAll(".sidenav-menu"),
                        s = 0,
                        o = i.length;
                      s < o;
                      s++
                    )
                      (i[s].style.marginRight = null),
                        (i[s].style.marginLeft = null);
                  ...
                  if (
                    (e.classList.contains(i)
                      ...
                      : e.classList.contains("sidenav-item") &&
                        (t = this._findChild(e, [i])),
                    !t.length)
                  )
                    throw new Error("`".concat(i, "` element not found."));
                  return t[0];
                },
              },
              {
                ...
                value: function (e, n) {
                  ...
                  if (
                    (e.classList.contains("sidenav-item")
                      ? this._findChild(e, [i]).length && (t = e)
                      : e.classList.contains(i) &&
                        (t = e.parentNode.classList.contains("sidenav-item")
                          ? e.parentNode
                          : null),
                    !t)
                  )
                ...
                value: function (e, n) {
                  for (var t = [], i = null; e; )
                    e.classList.contains("disabled")
                      ? ((i = null), (t = []))
                      : (e.classList.contains("open") || (i = e), t.push(e)),
                      (e = this._findParent(e, "sidenav-item", !1));
                  if (!i) return null;
                  if (1 === t.length) return i;
                  for (
                    var s = 0, o = (t = t.slice(0, t.indexOf(i))).length;
                    s < o;
                    s++
                  )
                    if ((t[s].classList.add("open"), this._accordion))
                      for (
                        var r = this._findChild(t[s].parentNode, [
                            "sidenav-item",
                            "open",
                          ]),
                          l = 0,
                        ...
                        if (r[l] !== t[s] && (r[l].classList.remove("open"), n))
                          for (
                            var d = r[l].querySelectorAll(".sidenav-item.open"),
                              h = 0,
                              c = d.length;
                            h < c;
                            h++
              ...
              },
              {
                ...
                value: function (e, n) {
                  for (
                    var t = this._findChild(e.parentNode, [
                        "sidenav-item",
                        "open",
                      ]),
                      i = 0,
              ...
              },
              {
                ...
                value: function (e, n, t) {
                  ...
                  var l = function () {
                    n.classList.remove("sidenav-item-animating"),
                      n.classList.remove("sidenav-item-closing"),
                  ...
                  e
                    ? ((n.style.height = "".concat(r, "px")),
                      n.classList.add("sidenav-item-animating"),
                      n.classList.add("open"),
                      this._bindAnimationEndEvent(n, function () {
                        l(), i._onOpened && i._onOpened(i, n, s, o);
                      }),
                      setTimeout(function () {
                        return (n.style.height = "".concat(
                          r + Math.round(o.getBoundingClientRect().height),
                          "px"
                        ));
                      }, 50))
                    : ((n.style.height = "".concat(
                      ...
                      n.classList.add("sidenav-item-animating"),
                      n.classList.add("sidenav-item-closing"),
                      this._bindAnimationEndEvent(n, function () {
                        if ((n.classList.remove("open"), l(), t))
                          for (
                            var e = n.querySelectorAll(".sidenav-item.open"),
                              r = 0,
                              a = e.length;
                            r < a;
                            r++
                ...
                value: function (e, n, t) {
                  ...
                  if (e) {
                    ...
                    r + this._innerPosition + a > s &&
                      a < s &&
                      a > l &&
                      (i.style[this._rtl ? "marginRight" : "marginLeft"] =
                        "-".concat(a - l, "px")),
                      this._closeOther(n, t),
                      this._updateSlider();
                  } else {
                    ...
                    if (
                      ...
                      for (
                        var h = i.querySelectorAll(".sidenav-item.open"),
                          c = 0,
                          v = h.length;
                        c < v;
                        c++
                      )
                        h[c].classList.remove("open");
                  }
                },
              },
              {
                ...
                value: function (e) {
                  var n,
                    t = Math.round(this._wrapper.getBoundingClientRect().width),
                    i = this._innerWidth;
                  "next" === e
                    ? i + (n = this._getSlideNextPos()) < t && (n = t - i)
                    : (n = this._getSlidePrevPos()) > 0 && (n = 0),
                  ...
                  (s = parseFloat(s) * (-1 !== s.indexOf("ms") ? 1 : 1e3)),
                    ...
                    o.forEach(function (n) {
                      return e.addEventListener(
                        n,
                        e._sideNavAnimationEndEventCb,
                        !1
                      );
                    }),
                    (e._sideNavAnimationEndEventTimeout = setTimeout(
                      function () {
                        i({ target: e });
                      },
                      s + 50
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  e._sideNavAnimationEndEventTimeout &&
                    (clearTimeout(e._sideNavAnimationEndEventTimeout),
                    (e._sideNavAnimationEndEventTimeout = null)),
                    n &&
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (this._evntElClick = function (n) {
                    var t = n.target.classList.contains("sidenav-toggle")
                      ? n.target
                      : e._findParent(n.target, "sidenav-toggle", !1);
                    t &&
                      (n.preventDefault(),
                      "true" !== t.getAttribute("data-hover") && e.toggle(t));
                  }),
                    this._el.addEventListener("click", this._evntElClick),
                    (this._evntWindowResize = function () {
                      e._horizontal
                        ? e._lastWidth !== window.innerWidth &&
                          ((e._lastWidth = window.innerWidth), e.update())
                        : e.update();
                    }),
                    window.addEventListener("resize", this._evntWindowResize),
                    this._horizontal &&
                      ((this._evntPrevBtnClick = function (n) {
                        n.preventDefault(),
                          e._prevBtn.classList.contains("disabled") ||
                            e._slide("prev");
                      }),
                      ...
                      (this._evntNextBtnClick = function (n) {
                        n.preventDefault(),
                          e._nextBtn.classList.contains("disabled") ||
                            e._slide("next");
                      }),
                      ...
                      (this._evntBodyClick = function (n) {
                        !e._inner.contains(n.target) &&
                          e._el.querySelectorAll(
                            ".sidenav-inner > .sidenav-item.open"
                          ).length &&
                          e.closeAll();
                      }),
                      ...
                      (this._evntHorizontalElClick = function (n) {
                        var t = n.target.classList.contains("sidenav-link")
                          ? n.target
                          : e._findParent(n.target, "sidenav-link", !1);
                        t &&
                          !t.classList.contains("sidenav-toggle") &&
                          e.closeAll();
                      }),
                      ...
                      this._showDropdownOnHover &&
                        ((this._evntInnerMousemove = function (n) {
                          for (
                            var t = e._findParent(n.target, "sidenav-item", !1),
                              i = null;
                            t;

                          )
                            (i = t), (t = e._findParent(t, "sidenav-item", !1));
                        ...
                        (this._evntInnerMouseleave = function (n) {
                          e.closeAll();
                        }),
                        this._inner.addEventListener(
                          "mouseleave",
              ...
              },
              {
                ...
                value: function (e) {
                  for (var n = e.childNodes[0], t = null; n && !t; )
                    n.classList &&
                      n.classList.contains("sidenav-menu") &&
                      (t = n),
                      (n = n.nextSibling);
                  if (!t)
                    throw new Error(
              ...
              },
              {
                ...
                value: function (e, n) {
                  ...
                  for (
                    ...
                    e = e.parentNode;
                  if (
                    !(e = e && "BODY" !== e.tagName.toUpperCase() ? e : null) &&
                    t
                  )
                    throw new Error(
              ...
              },
              {
                ...
                value: function (e, n) {
                  for (
                    var t = e.childNodes, i = [], s = 0, o = t.length;
                    s < o;
                    s++
                  )
                    if (t[s].classList) {
                      for (var r = 0, l = 0; l < n.length; l++)
                        t[s].classList.contains(n[l]) && r++;
