! function(t, e) {
    ...
    541: function(t, e, s) {
        ...
        var d = ["rtl", "style", "layoutPosition", "layoutNavbarFixed", "layoutFooterFixed", "layoutReversed", "navbarBg", "sidenavBg", "footerBg", "themes"],
            g = ["light", "material", "dark"],
            u = function() {
                function t(e) {
                    var s = e.cssPath,
                        i = e.themesPath,
                        ...
                        f = e.defaultTheme,
                        p = e.pathResolver,
                        y = e.onSettingsChange,
                        b = e.lang;
                    if (function(t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                        }(this, t), !this._ssr) {
                        if (!window.layoutHelpers) throw new Error("window.layoutHelpers required.");
                        if (this.settings = {}, this.settings.cssPath = s, this.settings.themesPath = i, this.settings.cssFilenamePattern = n || "%name%.css", this.settings.navbarBgs = c || t.NAVBAR_BGS, this.settings.defaultNavbarBg = h || "navbar-theme", this.settings.sidenavBgs = o || t.SIDENAV_BGS, this.settings.defaultSidenavBg = l || "sidenav-theme", this.settings.footerBgs = u || t.FOOTER_BGS, this.settings.defaultFooterBg = v || "footer-theme", this.settings.availableThemes = m || t.AVAILABLE_THEMES, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== f ? f : 1), this.settings.controls = a || d, this.settings.styles = r || g, this.settings.lang = b || "en", this.pathResolver = p || function(t) {
                                return t
                            }, this.settings.styles.length < 2) {
                            var _ = this.settings.controls.indexOf("style"); - 1 !== _ && (this.settings.controls = this.settings.controls.slice(0, _).concat(this.settings.controls.slice(_ + 1)))
                        }
                        this.settings.onSettingsChange = "function" == typeof y ? y : function() {}, this._loadSettings(), this._listeners = [], this._controls = {}, this._initDirection(), this._initStyle(), this._initTheme(), this.setLayoutPosition(this.settings.layoutPosition, !1), this.setLayoutNavbarFixed(this.settings.layoutNavbarFixed, !1), this.setLayoutFooterFixed(this.settings.layoutFooterFixed, !1), this.setLayoutReversed(this.settings.layoutReversed, !1), this._setup(), this._waitForNavs()
                    }
                }
                var e, s, i;
                return e = t, (s = [{
                    ...
                    key: "setStyle",
                    value: function(t) {
                        this._hasControls("style") && (this._setSetting("Style", -1 === ["material", "dark"].indexOf(t) ? "light" : t), window.location.reload())
                    }
                }, {
                    key: "isLightStyle",
                    value: function() {
                    ...
                    value: function(t) {
                        ...
                        if (this._hasControls("themes")) {
                            ...
                            if (i) {
                                ...
                                var n = this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", t + ("light" !== this.settings.style ? "-".concat(this.settings.style) : "")));
                                this._loadStylesheets(c({}, n, document.querySelector(".theme-settings-theme-css")), s || function() {}), e && this.settings.onSettingsChange.call(this, this.settings)
                            }
                        }
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        if (this._hasControls("sidenavBg") && -1 !== this.settings.sidenavBgs.indexOf(t)) {
                            ...
                            if (i) {
                                ...
                                var n = t.split(" ");
                                i.classList.contains("sidenav-horizontal") && ((n = n.join(" ").replace(" sidenav-dark", "").replace(" sidenav-light", "").split(" "))[0] = n[0].replace(/-darke?r?$/, "")), i.classList.add("bg-".concat(n[0]));
                                for (var a = 1, r = n.length; a < r; a++) i.classList.add(n[a]);
                                e && this.settings.onSettingsChange.call(this, this.settings)
                            }
                        }
                    ...
                    value: function(e) {
                        ...
                        if (e !== this.settings.lang || i) {
                            ...
                            var n = t.LANGUAGES[e];
                            ["panel_header", "rtl_switcher", "style_switcher_light", "style_switcher_material", "style_switcher_dark", "layout_header", "layout_static", "layout_offcanvas", "layout_fixed", "layout_fixed_offcanvas", "layout_navbar_swicher", "layout_footer_swicher", "layout_reversed_swicher", "navbar_bg_header", "sidenav_bg_header", "footer_bg_header", "theme_header"].forEach((function(t) {
                                var e = s.container.querySelector(".theme-settings-t-".concat(t));
                                e && (e.textContent = n[t])
                            }));
                            for (var a = n.themes || {}, r = this.container.querySelectorAll(".theme-settings-theme-item") || [], o = 0, l = r.length; o < l; o++) {
                                var c = r[o].querySelector('input[type="radio"]').value;
                                r[o].querySelector(".theme-settings-theme-name").textContent = a[c] || this._getThemeByName(c).title
                            }
                    ...
                    value: function() {
                        this._ssr || (this._setSetting("Theme", ""), this._setSetting("Rtl", ""), this._setSetting("Style", ""), this._setSetting("LayoutReversed", ""), this._setSetting("FixedNavbar", ""), this._setSetting("FixedFooter", ""), this._setSetting("LayoutPosition", ""), this._setSetting("NavbarBg", ""), this._setSetting("SidenavBg", ""), this._setSetting("FooterBg", ""))
                    }
                }, {
                    key: "destroy",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        this._cleanup(), this.container = this._getElementFromString(n.a);
                        ...
                        var a = this.container.querySelector(".theme-settings-close-btn"),
                            o = function() {
                        ...
                        a.addEventListener("click", o), this._listeners.push([a, "click", o]);
                        ...
                        var g = this.container.querySelector(".theme-settings-style");
                        if (this._hasControls("style")) {
                            var u = g.querySelector("select");
                            this.settings.styles.forEach((function(e) {
                                var s = t._getElementFromString('<option value="'.concat(e, '" class="theme-settings-t-style_switcher_').concat(e, '" ').concat(t.settings.style === e ? 'selected="selected"' : "", "></option>"));
                                u.appendChild(s)
                            }));
                            var v = function(e) {
                                t._loadingState(!0), t.setStyle(e.target.value)
                            };
                            u.addEventListener("change", v), this._listeners.push([u, "change", v])
                        ...
                        if (this._hasControls("layoutPosition layoutNavbarFixed layoutFooterFixed layoutReversed", !0)) {
                            ...
                            if (this._controls.layoutNavbarFixedW = this.container.querySelector(".theme-settings-layoutNavbarFixed"), this._hasControls("layoutNavbarFixed")) {
                                ...
                                this._controls.layoutNavbarFixed.addEventListener("change", y), this._listeners.push([this._controls.layoutNavbarFixed, "change", y])
                            ...
                            if (this._controls.layoutFooterFixedW = this.container.querySelector(".theme-settings-layoutFooterFixed"), this._hasControls("layoutFooterFixed")) {
                                ...
                                this._controls.layoutFooterFixed.addEventListener("change", b), this._listeners.push([this._controls.layoutFooterFixed, "change", b])
                        ...
                        var x = this.container.querySelector(".theme-settings-sidenavBg");
                        this._hasControls("sidenavBg") ? (this._controls.sidenavBgWInner = x.querySelector(".theme-settings-sidenavBg-inner"), this.settings.sidenavBgs.forEach((function(e) {
                            var s = t._getElementFromString(l.a),
                                i = s.querySelector("input");
                    ...
                    value: function() {
                        if (this._hasControls("style")) {
                            ...
                            this._insertStylesheet("theme-settings-bootstrap-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "bootstrap" + ("light" !== t ? "-".concat(t) : "")))), this._insertStylesheet("theme-settings-appwork-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "appwork" + ("light" !== t ? "-".concat(t) : "")))), this._insertStylesheet("theme-settings-colors-css", this.pathResolver(this.settings.cssPath + this.settings.cssFilenamePattern.replace("%name%", "colors" + ("light" !== t ? "-".concat(t) : "")))), ("light" === t ? ["material-style", "dark-style"] : "material" === t ? ["light-style", "dark-style"] : ["light-style", "material-style"]).forEach((function(t) {
                                document.documentElement.classList.remove(t)
                            })), document.documentElement.classList.add("".concat(t, "-style")), "material" === t && window.attachMaterialRipple && (document.body ? window.attachMaterialRipple() : window.addEventListener("DOMContentLoaded", (function() {
                    ...
                    key: "_initTheme",
                    value: function() {
                        this._hasControls("themes") && this._insertStylesheet("theme-settings-theme-css", this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", this.settings.theme.name + ("light" !== this.settings.style ? "-".concat(this.settings.style) : ""))))
                    }
                }, {
                    ...
                    value: function(t, e) {
                        ...
                        function a(t, e, s) {
                            ...
                            var n, a, r = "sheet" in i ? "sheet" : "styleSheet",
                                o = "sheet" in i ? "cssRules" : "rules";
                            n = setTimeout((function() {
                                clearInterval(a), clearTimeout(n), e.parentNode.removeChild(i), s(!1, t)
                            }), 15e3), a = setInterval((function() {
                                try {
                                    i[r] && i[r][o].length && (clearInterval(a), clearTimeout(n), e.parentNode.removeChild(e), s(!0))
                                } catch (t) {
                                    console.error(t)
                                }
                    ...
                    value: function(t, e, s) {
                        ...
                        this._observers || (this._observers = []), this._intervals || (this._intervals = []), document.querySelector(t) ? s.call(this) : document.body || ("undefined" != typeof MutationObserver ? (i = new MutationObserver((function(t) {
                            t.forEach((function(t) {
                                if (t.addedNodes)
                                    for (var n = 0; n < t.addedNodes.length; n++) {
                                        ...
                                        if (e.call(a, r)) {
                                            i.disconnect(), a._observers.splice(a._observers.indexOf(i), 1), i = null, s.call(a);
                                            break
                                        }
                                    }
                            }))
                            ...
                            document.querySelector(t) && (clearInterval(n), a._intervals.splice(a._intervals.indexOf(n), 1), n = null, s.call(a))
                        }), 10), this._intervals.push(n)))
                    }
                }, {
                    key: "_clearObservers",
                    value: function() {
                    ...
                    key: "_getThemeByName",
                    value: function(t) {
                        for (var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], s = this.settings.availableThemes, i = 0, n = s.length; i < n; i++)
        ...
        }], u.NAVBAR_BGS = ["navbar-theme", "primary", "primary-dark navbar-dark", "primary-darker navbar-dark", "secondary", "secondary-dark navbar-dark", "secondary-darker navbar-dark", "success", "success-dark navbar-dark", "success-darker navbar-dark", "info", "info-dark navbar-dark", "info-darker navbar-dark", "warning", "warning-dark navbar-light", "warning-darker navbar-light", "danger", "danger-dark navbar-dark", "danger-darker navbar-dark", "dark", "white", "light", "lighter"], u.SIDENAV_BGS = ["sidenav-theme", "primary", "primary-dark sidenav-dark", "primary-darker sidenav-dark", "secondary", "secondary-dark sidenav-dark", "secondary-darker sidenav-dark", "success", "success-dark sidenav-dark", "success-darker sidenav-dark", "info", "info-dark sidenav-dark", "info-darker sidenav-dark", "warning", "warning-dark sidenav-light", "warning-darker sidenav-light", "danger", "danger-dark sidenav-dark", "danger-darker sidenav-dark", "dark", "white", "light", "lighter"], u.FOOTER_BGS = ["footer-theme", "primary", "primary-dark footer-dark", "primary-darker footer-dark", "secondary", "secondary-dark footer-dark", "secondary-darker footer-dark", "success", "success-dark footer-dark", "success-darker footer-dark", "info", "info-dark footer-dark", "info-darker footer-dark", "warning", "warning-dark footer-light", "warning-darker footer-light", "danger", "danger-dark footer-dark", "danger-darker footer-dark", "dark", "white", "light", "lighter"], u.LANGUAGES = {
            en: {
    ...
    89: function(t, e, s) {
            ...
            for (var s = {}, i = [], n = 0; n < t.length; n++) {
                ...
                var d = o(h),
                    g = {
                        ...
                        media: a[2],
                        sourceMap: a[3]
                    }; - 1 !== d ? (r[d].references++, r[d].updater(g)) : r.push({
                    identifier: h,
                    updater: f(g, e),
                    references: 1
                }), i.push(h)
        ...
        function f(t, e) {
            ...
            if (e.singleton) {
                var a = m++;
                s = v || (v = c(e)), i = g.bind(null, s, a, !1), n = g.bind(null, s, a, !0)
            } else s = c(e), i = u.bind(null, s, e), n = function() {
                ! function(t) {
        ...
        t.exports = function(t) {
            ...
            return e.toString = function() {
                return this.map((function(e) {
                    var s = function(t, e) {
                        ...
                        if (e && "function" == typeof btoa) {
                            var n = (r = i, o = btoa(unescape(encodeURIComponent(JSON.stringify(r)))), l = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(o), "/*# ".concat(l, " */")),
                ...
                for (var o = 0; o < t.length; o++) {
                    var l = [].concat(t[o]);
                    i && n[l[0]] || (s && (l[2] ? l[2] = "".concat(s, " and ").concat(l[2]) : l[2] = s), e.push(l))
                }
            }, e
        }
    }
